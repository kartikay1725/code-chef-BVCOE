        ...
        {active && typeof active === "object" ? (
          <div className="fixed inset-0 grid place-items-center z-[100]">
            ...
            <motion.div
              ...
              ref={ref}
              className="w-full max-w-[500px] h-full md:h-fit md:max-h-[90%] flex flex-col bg-lime-600 dark:bg-neutral-900 sm:rounded-3xl overflow-hidden"
            >
      ...
      <ul className="max-w-2xl mx-auto w-full gap-4">
        {cards.map((card) => (
          <motion.div
            ...
            className="p-4 flex flex-col justify-between items-start text-violet-950 hover:bg-black/20 dark:hover:bg-neutral-800 rounded-xl cursor-pointer"
          >
            <motion.h3
